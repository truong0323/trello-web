...
import { clearAndHideCurrentActiveCard,
        ...
        updateCurrentActiveCard } from '~/redux/activeCard/activeCardSlice'    
 ...
 */
function ActiveCard() {
  //Khôgn dùng biến state để check đóng mở Modal nũa vì chúng ta sẽ check theo cái biến isShowModalActiveCard trong redux
  ...
  // function gọi api dùng chung cho các trường hợp update : cardtitle , description,cover,comment,...
