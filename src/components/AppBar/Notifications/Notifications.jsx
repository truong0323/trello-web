...
function Notifications() {
  ...
  const handleClickNotificationIcon = (event) => {
    ...
    //khi click phần quả chuông thông báo thì xét lại trạng thái của biến newNotification về false
  ...
  //lấy dữ liệu user trong redux để hỗ trợ tính năng real-time
  ...
  useEffect(() => {
    ...
    const onReceiveNewInvitation = (invitation) => {
      // nếu cái thằng user đang đăng nhập hiện tại mà lưu trong redux chính là thằng invitee trong bản ghi invitation
    ...
    //Lắng nghe một sự kiện real-time có tên là BE_US ER_INVITED_TO_BOARD từ phía server BE gửi về
